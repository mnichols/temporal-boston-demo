<script>
	...
	import temporal from '$lib/images/temporal_logo.png';
	import temporalCloud from '$lib/images/temporal-cloud.png';
</script>

<header>
	<div class="corner">
        <a href="https://cloud.temporal.io/namespaces/temporal-demo-oms.sdvdw/workflows" target="_blank">
